    ...
    public static OptionPage page() {
        ...
        groups.add(OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(int.class, storage)
                        ...
                        .setControl(opt -> new SliderControl(opt, 1, CpuLayout.getCoreCount(), 1,
                                v -> Component.literal(Integer.toString(v))))
                        .setBinding((s, v) -> s.bakeThreads = v, s -> s.bakeThreads)
                        .setImpact(OptionImpact.HIGH)
                        .setFlags(OptionFlag.REQUIRES_RENDERER_RELOAD)
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, storage)
        ...
        groups.add(OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(boolean.class, storage)
                        ...
                        .setControl(TickBoxControl::new)
                        .setBinding((s, v) -> s.highResModelTextures = v, s -> s.highResModelTextures)
                        .setImpact(OptionImpact.HIGH)
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, storage)
